...
class InMemoryNotifRepo {
    ...
    preferences = new Map();
    async findById(id) { return this.notifications.get(id) ?? null; }
    ...
    async save(rec) { this.notifications.set(rec.id, rec); }
    async markRead(id) {
    ...
    async getPreference(recipientId) { return this.preferences.get(recipientId) ?? null; }
    async savePreference(pref) { this.preferences.set(pref.recipientId, pref); }
}
// ─── Seeded data ──────────────────────────────────────────────────────────────
